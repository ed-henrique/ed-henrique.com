...
live/server:
	...
	--build.cmd "go build -o bin/main cmd/api/main.go" --build.bin "bin/main" --build.delay "100" \
...
live/tailwind:
	npx tailwindcss -i ./public/css/input.css -o ./public/css/output.css --minify --watch
...
prod:
	...
	@mkdir -p bin
	@go build -trimpath -ldflags "-s -w" -o bin/main cmd/api/main.go
